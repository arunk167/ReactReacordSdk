...
import com.selflearningcoursecreationapp.utils.ScreenRecording
...
import com.selflearningcoursecreationapp.utils.services.ControllerServices
...
//        params.y = 50
    ...
    override fun onDestroy() {
        try {
            startControllerService(intentIs)
...
//        recorderIntent.putExtras(bundleOf("recordingStatus" to 4))
            try {
                ...
                recorderIntent.putExtras(bundleOf("recordingStatus" to ScreenRecording.TIMER_STOPPED))
    ...
    private fun startControllerService(data: Intent?) {
        val intent2 = Intent(this, ControllerServices::class.java)
        intent2.putExtra("command", ScreenRecording.START_REC)
        intent2.putExtra("largeIconId", R.mipmap.ic_launcher)
        intent2.putExtra("smallIconId", R.mipmap.ic_launcher)
