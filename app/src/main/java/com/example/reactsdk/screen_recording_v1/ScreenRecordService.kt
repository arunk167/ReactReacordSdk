        ...
        ScreenRecorder(
            ...
            videoCallback = {
                try {
                    ...
                    recorderIntent.putExtras(bundleOf("recordingStatus" to ScreenRecording.CLOSE_SERVICES))
...
//                }
            ...
            ScreenRecording.RESUME_REC -> {
                screenRecorder.resume()
            }
            ScreenRecording.PAUSE_REC -> {
